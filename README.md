...
3. Whenever you press the start key on the keyboard, instead of opening the default windows start it opens this windows 8 start, but if you press start button in the taskbar it won't work, but this is still in beta